...
while true; do
    ...
    if grep "$disk_chk" devices; then
        ...
        if [ "$auto_prov_ans" = "y" ]; then
            ...
            lvcreate -L 8GiB gentooVG -n gentooSwap
            lvcreate -L 24GiB gentooVG -n gentooRoot
...
mv gentooVM /mnt/gentoo
mv gentooVM.zip /mnt/gentoo/
mv network_devices /mnt/gentoo/gentooVM/
cd /mnt/gentoo/gentooVM

install_vars=/mnt/gentoo/gentooVM/install_vars
...
cd /mnt/gentoo/gentooVM/gentoo/
cp -a /mnt/gentoo/gentooVM/gentoo/portage/package.use/. /mnt/gentoo/etc/portage/package.use/
cd /mnt/gentoo/
rm -rf /mnt/gentoo/etc/portage/make.conf
##copies our pre-made make.conf over
cp /mnt/gentoo/gentooVM/gentoo/portage/make.conf /mnt/gentoo/etc/portage/
...
#cp /mnt/gentoo/gentooVM/gentoo/portage/linux_drivers /mnt/gentoo/etc/portage/
cp /mnt/gentoo/gentooVM/gentoo/portage/package.license /mnt/gentoo/etc/portage
#cp /mnt/gentoo/gentooVM/gentoo/portage/package.accept_keywords /mnt/gentoo/etc/portage/
#cp -r /mnt/gentoo/gentooVM/gentoo/portage/profile /mnt/gentoo/etc/portage/
...
cp /mnt/gentoo/gentooVM/post_chroot.sh /mnt/gentoo/
cp /mnt/gentoo/gentooVM/install_vars /mnt/gentoo/
