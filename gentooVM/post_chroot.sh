...
if [ $kernelanswer = "no" ]; then
	#cp /gentooVM/gentoo/kernel/gentoominimal /root/kernel.config
	#genkernel --kernel-config=/root/kernel.config all
	cp /gentooVM/gentoo/kernel/gentoominimal /usr/src/linux/.config
...
rm -rf /install_vars
cp -r /gentooVM/gentoo/portage/savedconfig /etc/portage/
cp -r /gentooVM/gentoo/portage/env /etc/portage/
cp /gentooVM/gentoo/portage/package.env /etc/portage/
rm -rf /gentooVM
